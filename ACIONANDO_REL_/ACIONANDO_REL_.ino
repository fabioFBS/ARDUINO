...
void loop() {
  ...
  buf += "<title>FBS</title> ";
  buf += "<style> ";
  buf += "body{font-family:Open Sans; color:#555555; background: lightgrey;} ";
  ...
  buf += "<p align='center'><font size='10'>Controle de lampadas de FBS</font></p> ";
  buf += "</div> ";
  buf += "</div> ";
  buf += "<div class='row'> ";
  buf += "<div class='col four'> ";
  buf += "<a href='?f=on' class='btn btn-sea'>Ligar Lampada</a> ";
  buf += "</div> ";
  buf += "<div class='col four'> ";
  buf += "<a href='?f=off' class='btn btn-sea'>Desligar Lampada</a> ";
  buf += "</div> ";
  buf += "</div> ";
  buf += "<div class='col twelve'> ";
  buf += "<p align='center'><font size='5'>FBS</font></p> ";
  buf += "</div> ";
  buf += "</div> ";
  buf += "</body> ";
  buf += "</html> ";
